...
export const TelephonyHardwareCartItem = ({ product, taxRate, onQuantityChange, onRemove }) => {
  const t = useTranslations('cart');
  const commonT = useTranslations('common');

  // Use the same logic as TvHardwareCartItem to determine pricing type
  ...
  // Determine actual pricing based on paytype (like TvHardwareCartItem)
  let actualPrice = 0;
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between">
        <div className="pr-0 sm:pr-6">
          ...
          {/* Additional telephony hardware information */}
          ...
          {/* Contract terms and payment type info - same as TV hardware */}
