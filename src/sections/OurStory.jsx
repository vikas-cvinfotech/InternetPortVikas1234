        ...
        <div className="-mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 bg-primary p-5 lg:p-10 rounded-md shadow-sm gap-x-[60px] gap-y-4">
            <div className="relative mx-auto flex flex-col items-start justify-center">
              ...
              <a
                href="/om-oss"
                className="my-4 lg:mt-8 lg:mb-0 flex items-center gap-2  rounded-md border border-transparent bg-accent hover:bg-[#9C1821] transition-colors duration-300 px-8 py-3 text-sm font-medium text-primary "
              >
                {t('button')}
                <svg
                  width="17"
